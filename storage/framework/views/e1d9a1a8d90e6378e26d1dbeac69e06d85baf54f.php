            ...
            <div class="row text-center mb-5">
                ...
                <div class="col-8 pt-4">
                    <h3 style="font-size:28px;">
                        <strong><?php echo e(env('SCHOOL_NAME')); ?></strong>
                        <br>
                        <strong><?php echo e(env('SCHOOL_ADDRESS')); ?></strong> 
                    </h3>
            ...
            <div class="p-3">
                <h5>
                    ...
                    <div class="d-flex mb-1">
                        ...
                        <span style="flex-grow: 1;border-bottom:2px dotted black;padding-right:20px;"><span style="margin-left: 20px;"><?php echo e($std->nepali_dob); ?></span></span>
                    </div>
