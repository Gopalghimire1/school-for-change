            ...
            <?php if(@in_array(5, $modules) || Auth::user()->role_id == 1): ?>
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="subMenuFeesCollection">
                        ...
                        <li>
                           <a href="<?php echo e(route('scholarship_create')); ?>">GENERATE SCHOLARSHIP</a>
                        </li>
                        <?php endif; ?>
                        <?php if(Auth::user()->role_id == 1): ?>
                            <li>
                               <a href="<?php echo e(route('fees_by_lavel')); ?>">FEES BY CLASS</a>
                            </li>
                        <?php endif; ?>
                        <?php if(Auth::user()->role_id == 1): ?>
                            <li>
                               <a href="<?php echo e(route('bill_create')); ?>">Credit Bill Issue</a>
                            </li>
                        <?php endif; ?>
                       
                        <?php if(@in_array(113, $module_links) || Auth::user()->role_id == 1): ?>
                            <li>
                                <a href="<?php echo e(route('search_fees_payment')); ?>">Search Paid Fees</a>
                            </li>
                        <?php endif; ?>
                        <?php if(@in_array(116, $module_links) || Auth::user()->role_id == 1): ?>
                            <li>
                                <a href="<?php echo e(route('search_fees_due')); ?>">Search Due Fees</a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="subMenuExam">
                        <?php if(@in_array(208, $module_links) || Auth::user()->role_id == 1): ?>
                            <li>
                                <a href="<?php echo e(url('exam-type')); ?>">Manage Exam</a>
                            </li>
                        <?php endif; ?>
            ...
            <?php if(@in_array(18, $modules) || Auth::user()->role_id == 1): ?>
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="subMenusystemSettings">
                        ...
                        <?php if(Auth::user()->role_id == 1): ?>
                        <li>
                           <a href="<?php echo e(route('fiscal_year')); ?>">Fiscal Year</a>
                        </li>
                        <?php endif; ?>
