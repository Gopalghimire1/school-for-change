                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-effect">
                                    <input type="checkbox" id="subject_<?php echo e($student->id); ?>_<?php echo e($student->admission_no); ?>" class="common-checkbox" name="abs[<?php echo e($student->id); ?>]" value="1" <?php if($is_absent){echo 'checked';} ?> >
