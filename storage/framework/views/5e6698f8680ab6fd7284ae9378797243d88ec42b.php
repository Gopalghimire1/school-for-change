                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($value->marks); ?></td>
                                 ...
                                 <td  data-sort="<?php echo e(strtotime($value->submission_date)); ?>" ><?php echo e($value->submission_date != ""? App\SmGeneralSettings::DateConvater($value->submission_date):''); ?></td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                         ...
                                         <a class="dropdown-item modalLink" title="Homework View" data-modal-size="modal-lg" href="<?php echo e(route('parent_homework_view', [$value->class_id, $value->section_id, $value->id])); ?>">View</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
