    ...
    <div class="row">
        <div class="col-md-4" >
            <div style="background:white; padding:10px; border-radius:5px;">
                <form action="<?php echo e(route('scholarship_update',$scholarship_edit->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="form-group">
                        <label for="title">Title</label>
                        <input type="text" value="<?php echo e($scholarship_edit->title); ?>" name="title" placeholder="Enter title" class="form-control" required>
                    </div>
                    <div class="form-group">
                        ...
                        <select name="student_id" class="selectpicker" data-width="auto" data-live-search="true" data-size="10" required>
                           ...
                           <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stds): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                               <option value="<?php echo e($stds->id); ?>" <?php echo e($stds->id == $scholarship_edit->student_id ? 'selected' : ''); ?>><?php echo e($stds->full_name); ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="class_id" class="form-control" required>
                            ...
                            <?php $__currentLoopData = $class; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($c->id); ?>" <?php echo e($c->id == $scholarship_edit->class_id ? 'selected' : ''); ?>><?php echo e($c->class_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select name="fee_id" class="form-control" required>
                            ...
                            <?php $__currentLoopData = $fees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($f->id); ?>" <?php echo e($f->id == $scholarship_edit->fee_id ? 'selected' : ''); ?>><?php echo e($f->text); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" value="<?php echo e($scholarship_edit->percentage); ?>" name="percentage" class="form-control" id="inper" placeholder="Enter percentage" >
                    </div>
                    <div class="form-group">
                        <label for="amount">In Amount</label>
                        <input type="number" value="<?php echo e($scholarship_edit->amount); ?>" name="amount" class="form-control" id="inamt" placeholder="Enter Amount" >
                    </div>
                    <hr>
                    <div class="form-group">
